...
<div class="grid_main_l">
	<a href="<%=request.getContextPath()%>/admin/them-moi-tin-tuc?type=load" class="dashboard-module">
		<img src="<%=request.getContextPath()%>/templates/admin/images/Crystal_Clear_write.gif" width="64" height="64" alt="edit" />
		<span>Thêm tin tức</span>
	</a>
	
	<a href="<%=request.getContextPath()%>/admin/them-moi-danh-muc" class="dashboard-module">
